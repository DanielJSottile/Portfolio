  ...
  constructor(props) {
    ...
    this.state = {
      projects: [
        {
          ...
          techStack: {
            ...
            'SAAS': <img className="icon" src={require('../Images/440px-Sass-Logo-Color.png')} alt='SASS-icon'/>,
            'CSS': <i className="fab fa-css3-alt"></i>, 
            'TypeScript': <img className="icon" src={require('../Images/1200px-Typescript_logo_2020.png')} alt='TypeScript-icon'/>,
            'JavaScript': <i className="fab fa-js"></i>,
            'React': <i className="fab fa-react"></i>,
            'Node.js': <i className="fab fa-node-js"></i>, 
            'Express': null, 
            'Jest': <img className="icon" src={require('../Images/jest.png')} alt='Jest-icon'/>,
            'Enzyme': <img className="icon" src={require('../Images/enzyme.png')} alt='Enzyme-icon'/>, 
            'Mocha': <img className="icon" src={require('../Images/mocha.png')} alt='Mocha-icon'/>,
            'Chai': null, 
            'Supertest': null, 
            'XSS': null, 
            'Winston':  null, 
            'NYC': null, 
            'PostgreSQL': <img className="icon" src={require('../Images/elephant.png')} alt='PostgreSQL-icon'/>,
            'Knex': <img className="icon" src={require('../Images/knex.png')} alt='Knex-icon'/>,
            'Lodash': <img className="icon" src={require('../Images/Lodash.png')} alt='Lodash-icon'/>,
            'Pre-Commit': <img className="icon" src={require('../Images/precommit.png')} alt='Pre-Commit-icon'/>,
           },
        },
        {
          id: 2,
          ...
          desc: 'A Landing Page demo for a prospective employer, this page uses React-Spring and React Scroll Animation to create a lively and interesting landing page!  Feel free to see what I can do!  Please note that this is a work in progress and looks best on desktop views at the moment!',
          techStack: {
            'HTML5': <i className="fab fa-html5"></i>, 
            'SAAS': <img className="icon" src={require('../Images/440px-Sass-Logo-Color.png')} alt='SASS-icon'/>,
            'CSS': <i className="fab fa-css3-alt"></i>, 
            ...
            'JavaScript': <i className="fab fa-js"></i>,
            'React': <i className="fab fa-react"></i>, 
            'React-Spring': <img className="icon" src={require('../Images/React-spring.png')} alt='React-Spring-icon'/>,
            'Pre-Commit': <img className="icon" src={require('../Images/precommit.png')} alt='Pre-Commit-icon'/>,
           },
        },
        {
          ...
          techStack: {
            ...
            'PostgreSQL': <img className="icon" src={require('../Images/elephant.png')} alt='PostgreSQL-icon'/>,
            'Knex': <img className="icon" src={require('../Images/knex.png')} alt='Knex-icon'/>,
            'TensorFlow.js': <img className="icon" src={require('../Images/TensorFlow.png')} alt='TensorFlow-icon'/>,
            'Crypto-js': null, 
           },
        },
        {
      ...
      techStack: {
        ...
        'JavaScript': <i className="fab fa-js"></i>,
        'TypeScript': <img className="icon" src={require('../Images/1200px-Typescript_logo_2020.png')} alt='TypeScript-icon'/>,
        'jQuery': <img className="icon" src={require('../Images/jquery.jpg')} alt='jquery-icon'/>,
        'React': <i className="fab fa-react"></i>, 
        'React Native': <img className="icon" src={require('../Images/react-native-logo.png')} alt='React-Native-icon'/>,
        'Redux': <img className="icon" src={require('../Images/redux.png')} alt='Redux-icon'/>,
        'Node.js': <i className="fab fa-node-js"></i>, 
        'Express': null, 
        'Jest': <img className="icon" src={require('../Images/jest.png')} alt='Jest-icon'/>,
        'Enzyme': <img className="icon" src={require('../Images/enzyme.png')} alt='Enzyme-icon'/>,  
